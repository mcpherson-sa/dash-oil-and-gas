...
columns1 = [
    'API Well Number', 'Gas Produced, MCF',
...
df1 = pd.read_csv(
    'data/Oil_and_Gas_Annual_Production__1985_-_2000.csv',
    low_memory=False)[columns1]

df2 = pd.read_csv(
    'data/Oil_and_Gas_Annual_Production__Beginning_2001.csv',
...
columns = [
    'Gas Produced, MCF', 'Water Produced, bbl',
...
for api, df_well in df.groupby('API Well Number'):
    ...
    df_well = df_well.drop_duplicates() #SM
